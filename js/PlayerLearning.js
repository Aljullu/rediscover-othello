        ...
        for (var i = 0; i < board.cellColumns; i++) {
            for (var j = 0; j < board.cellRows; j++) {
                if (board.cell[i][j].canPlayerPlay(scope.id)) {
                    ...
                    var advantageTmp = boardTmp.getCellsByPlayer(1) * scope.weights[0][0] +  boardTmp.getCellsByPlayer(2) * scope.weights[0][1] +  boardTmp.getBorderCellsByPlayer(1) * scope.weights[1][0] +  boardTmp.getBorderCellsByPlayer(2) * scope.weights[1][1] +  boardTmp.get4BorderCellsByPlayer(1) * scope.weights[2][0] +  boardTmp.get4BorderCellsByPlayer(2) * scope.weights[2][1];
